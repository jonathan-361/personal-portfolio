        ...
        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-2xl p-8 shadow-2xl spacey-6">
          ...
          <div className="space-y-4 mb-8">
            ...
            <p className="text-slate-300 leading-relaxed">
              La solicitud que enviaste no pudo ser procesada debido a un
              problema con los datos. Esto puede ocurrir cuando falta
              información importante o los datos no tienen el formato correcto.
            </p>
          </div>
          ...
          <div className="bg-slate-900/50 rounded-lg p-4 mb-8 border border-slate-700">
            <p className="text-sm text-slate-300">
              ...
              Verifica que hayas completado correctamente todos los campos
              requeridos.
            </p>
          </div>
