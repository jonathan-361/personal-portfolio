      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#0a0a0a]">
        <header className="sticky top-0 z-10 flex items-center justify-between p-8 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-gray-900/50">
          ...
          <Button
            ...
            className="bg-white text-black hover:bg-gray-200 font-bold gap-2 px-6 shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all"
          >
          ...
          <RadioGroup defaultValue="todo" className="gap-3">
            {[
              ...
              >
                ...
                >
                  <span className={`w-1.5 h-4 rounded-full ${option.color}`} />
                  {option.label}
                </Label>
              </div>
            ))}
